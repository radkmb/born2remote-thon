...
async def on_message(message):
    ...
    # 押した人がクラスターのボイスチャンネルに入ってたらそこにまざり、
    # そうでなかったら自分の部屋を作って招待する
    if message.content.startswith("/cim_two_voice"):
        category = discord.utils.get(guild.categories, name=VOICE_CATEGORY)
        name1 = message.content.split()[1]
        name2 = message.content.split()[2]
